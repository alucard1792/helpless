 ...
 * @author David
 */
@Named(value = "controladorListarPlanAsignados")
@ViewScoped
public class ControladorListarPlanAsignados implements Serializable {
    ...
    public ControladorListarPlanAsignados() {
    }

    @PostConstruct
    public void init() {
        listaPlanes = planMejoramientoFacade.listarSolicitudesAsignadas(controladorLogin.getUsuarioSesion());
